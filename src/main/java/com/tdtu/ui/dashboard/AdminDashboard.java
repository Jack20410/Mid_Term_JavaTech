...
public class AdminDashboard extends JPanel {
    ...
    private String currentUserName = "Admin"; // Set the username dynamically

    public AdminDashboard(AppFrame frame) {
        ...
        // Add the Update Avatar button under the avatar
        ...
        manageUsersButton.addActionListener(e -> parentFrame.showScreen("UserManagementUI"));
        manageStudentsButton.addActionListener(e -> {
            parentFrame.setCurrentUserRole("Admin");
